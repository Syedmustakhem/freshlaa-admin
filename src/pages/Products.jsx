...
export default function Products() {
  ...
  const toggleRamadanSpecial = async (product) => {
    try {
      const newStatus = !product.isRamadanSpecial;
      
      await api.patch(
        `/products/${product._id}/ramadan-special`,
        { isRamadanSpecial: newStatus },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
          },
      ...
      console.error("Failed to toggle Ramadan:", err);
      alert("Failed to update Ramadan status");
    }
  };
  ...
  return (
    <AdminLayout>
        ...
        <table className="table mb-0">
          <thead className="table-light">
            <tr>
              ...
              <th>Default Price</th>
              <th>Status</th>
              <th style={{ textAlign: 'center' }}>🌙 Ramadan</th>
              <th>Actions</th>
            </tr>
          </thead>
              ...
              products.map((p, i) => (
                <tr key={p._id}>
                  ...
                  <td style={{ textAlign: 'center' }}>
                    <input
                      type="checkbox"
                      checked={p.isRamadanSpecial || false}
                      onChange={() => toggleRamadanSpecial(p)}
                      style={{ 
                        width: '20px', 
                        height: '20px',
                        cursor: 'pointer'
                      }}
                      title="Add to Ramadan Special"
                    />
                  </td>
                  <td>
                    <button
      ...
      {/* ================= ALL YOUR EXISTING MODALS BELOW ================= */}
      {/* ADD PRODUCT MODAL - Keeping exactly as-is */}
      {showAddModal && (
          ...
          <div className="modal-dialog modal-xl">
            <div className="modal-content">
              ...
              <div className="modal-body">
                {/* ALL YOUR EXISTING ADD PRODUCT FORM CODE */}
      ...
      {/* EDIT PRODUCT MODAL - Keeping exactly as-is */}
      {editProduct && (
        <div className="modal d-block" style={{ background: "rgba(0,0,0,.5)" }}>
          <div className="modal-dialog modal-xl">
            <div className="modal-content">
      ...
      {/* VARIANTS MODAL - Keeping exactly as-is */}
      {variantProduct && (
        <div className="modal d-block" style={{ background: "rgba(0,0,0,.5)" }}>
          <div className="modal-dialog modal-xl">
            <div className="modal-content">
